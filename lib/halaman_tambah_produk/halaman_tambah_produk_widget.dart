...
class _HalamanTambahProdukWidgetState extends State<HalamanTambahProdukWidget> {
  ...
  void initState() {
    ...
    _model.kategoriProdukTextController ??= TextEditingController();
    _model.kategoriProdukFocusNode ??= FocusNode();
                          ...
                          children: [
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  if ((_model.apiResultUploudImage?.succeeded ??
                                      true)) {
                                    await showDialog(
                                      context: context,
                            ...
                            Align(
                              ...
                              child: SizedBox(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.kategoriProdukTextController,
                                  focusNode: _model.kategoriProdukFocusNode,
                                  autofocus: false,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    isDense: true,
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            _model.apiResultysp =
                              ...
                              category:
                                  _model.kategoriProdukTextController.text,
                              status: true,
