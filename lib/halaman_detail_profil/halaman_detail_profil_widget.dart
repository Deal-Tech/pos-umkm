...
import 'halaman_detail_profil_model.dart';
...
class HalamanDetailProfilWidget extends StatefulWidget {
  ...
  State<HalamanDetailProfilWidget> createState() =>
      _HalamanDetailProfilWidgetState();
}

class _HalamanDetailProfilWidgetState extends State<HalamanDetailProfilWidget> {
  late HalamanDetailProfilModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HalamanDetailProfilModel());
  }
