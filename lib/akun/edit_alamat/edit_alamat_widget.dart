...
class _EditAlamatWidgetState extends State<EditAlamatWidget> {
  late EditAlamatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditAlamatModel());
