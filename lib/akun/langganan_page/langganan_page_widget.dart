...
import 'langganan_page_model.dart';
export 'langganan_page_model.dart';

class LanggananPageWidget extends StatefulWidget {
  const LanggananPageWidget({super.key});

  @override
  State<LanggananPageWidget> createState() => _LanggananPageWidgetState();
}

class _LanggananPageWidgetState extends State<LanggananPageWidget> {
  late LanggananPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LanggananPageModel());
  }
