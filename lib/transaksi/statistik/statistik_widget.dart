...
import '/components/filter_report_widget.dart';
        ...
        body: SafeArea(
          ...
          child: FutureBuilder<ApiCallResponse>(
            future: (_model.apiRequestCompleter ??= Completer<ApiCallResponse>()
                  ..complete(ReportCall.call(
                    token: currentAuthenticationToken,
                    filter: FFAppState().filterreport,
                    startDate:
                        FFAppState().filterreportdate.datestart.toString(),
                    endDate: FFAppState().filterreportdate.dateend.toString(),
                  )))
                .future,
            builder: (context, snapshot) {
              ...
              final columnReportResponse = snapshot.data!;
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  FFAppState().filterreport = 'bulan_ini';
                                  safeSetState(() {});
                                  safeSetState(
                                      () => _model.apiRequestCompleter = null);
                                  await _model.waitForApiRequestCompleted();
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Builder(
                                builder: (context) {
                                  final terlaris = ReportStruct.maybeFromMap(
                                              columnReportResponse.jsonBody)
                                          ?.produkTerlaris
                                          .toList() ??
                                      [];
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemBuilder: (context, terlarisIndex) {
                                      final terlarisItem =
                                          terlaris[terlarisIndex];
                                      return Container(
                                        width: 100.0,
                                        height: 70.0,
                                        decoration: BoxDecoration(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Builder(
                                builder: (context) {
                                  final payment = ReportStruct.maybeFromMap(
                                              columnReportResponse.jsonBody)
