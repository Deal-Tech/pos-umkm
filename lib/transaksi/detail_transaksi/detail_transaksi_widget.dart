...
class DetailTransaksiWidget extends StatefulWidget {
...
class _DetailTransaksiWidgetState extends State<DetailTransaksiWidget> {
  late DetailTransaksiModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetailTransaksiModel());
  }
                            ...
                            child: Column(
                              ...
                              children: [
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          widget.transactionsid.toString(),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Rubik',
                                ...
                                FutureBuilder<ApiCallResponse>(
                                  future: ApiTransaksiGroup.getTransactionIDCall
                                      .call(
                                    transactionId:
                                        widget.transactionsid?.toString(),
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    final listViewGetTransactionIDResponse =
                                        snapshot.data!;

                                    return Builder(
                                      builder: (context) {
                                        final productlistdetail =
                                            TransactionsDetailStruct.maybeFromMap(
                                                        listViewGetTransactionIDResponse
                                                            .jsonBody)
                                                    ?.transactionDetails
                                                    .map((e) => e)
                                                    .toList()
                                        ...
                                        return ListView.separated(
                                          ...
                                          itemCount: productlistdetail.length,
                                          separatorBuilder: (_, __) =>
                                              const SizedBox(height: 10.0),
                                          itemBuilder: (context,
                                              productlistdetailIndex) {
                                            final productlistdetailItem =
                                                productlistdetail[
                                                    productlistdetailIndex];
                                            return Row(
                                              mainAxisSize: MainAxisSize.max,
                                ...
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 10.0, 0.0, 10.0),
                                  child: Text(
                                    'Terimakasih telah berbelanja. Semoga hari anda menyenangkan',
                                    textAlign: TextAlign.center,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
