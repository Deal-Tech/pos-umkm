...
import 'catatan_hutang_widget.dart' show CatatanHutangWidget;
import 'package:flutter/material.dart';

class CatatanHutangModel extends FlutterFlowModel<CatatanHutangWidget> {
  ...
  // Stores action output result for [Backend Call - API (Add Debt)] action in Button widget.
  ApiCallResponse? apiResultearu;
