                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder:
                                      ...
                                      final receivabletlistItem =
                                          receivabletlist[receivabletlistIndex];
                                      return Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            0.0, 20.0, 0.0, 0.0),
                                        child: Container(
                                              ...
                                              context.pushNamed(
                                                ...
                                                queryParameters: {
                                                  ...
                                                  'nominal': serializeParam(
                                                    receivabletlistItem.amount,
                                                    ParamType.int,
                                                  ),
                                                  'duedate': serializeParam(
                                                    receivabletlistItem.dueDate,
                                                    ParamType.String,
                                                  ),
                                                              ...
                                                              children: [
                                                                Container(
                                                                  ...
                                                                  decoration:
                                                                      BoxDecoration(
                                                                    color: () {
                                                                      if (receivabletlistItem
                                                                              .jenis ==
                                                                          'Pelanggan') {
                                                                        return const Color(
                                                                            0xFF00B2D1);
                                                                      } else if (receivabletlistItem
                                                                              .jenis ==
                                                                          'Suplier') {
                                                                        return const Color(
                                                                            0xFFFF9F05);
