...
import 'halaman_set_password_model.dart';
export 'halaman_set_password_model.dart';

class HalamanSetPasswordWidget extends StatefulWidget {
  const HalamanSetPasswordWidget({
    super.key,
    required this.phone,
  });
  ...
  @override
  State<HalamanSetPasswordWidget> createState() =>
      _HalamanSetPasswordWidgetState();
}

class _HalamanSetPasswordWidgetState extends State<HalamanSetPasswordWidget> {
  late HalamanSetPasswordModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HalamanSetPasswordModel());
    ...
    _model.konfirmsaiPaswordTextController ??= TextEditingController();
    _model.konfirmsaiPaswordFocusNode ??= FocusNode();
  }
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              _model.apiResultChangePassword =
                                  await ApiChangePasswordWithCodeCall.call(
                                phone: widget.phone,
                                resetCode:
                                    _model.kodeVerifikasiTextController.text,
                                password: _model.passwordTextController.text,
                                passwordConfirmation:
                                    _model.konfirmsaiPaswordTextController.text,
                              );
