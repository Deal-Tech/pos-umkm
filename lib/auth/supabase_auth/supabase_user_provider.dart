...
class CahrurPOSUMKMSupabaseUser extends BaseAuthUser {
  CahrurPOSUMKMSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> cahrurPOSUMKMSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = CahrurPOSUMKMSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
