...
class OtherPageWidget extends StatefulWidget {
  const OtherPageWidget({super.key});

  @override
  State<OtherPageWidget> createState() => _OtherPageWidgetState();
}

class _OtherPageWidgetState extends State<OtherPageWidget> {
  late OtherPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OtherPageModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final otherPageApiGetUserResponse = snapshot.data!;
                                ...
                                children: [
                                  Text(
                                    valueOrDefault<String>(
                                      ApiGetUserCall.nama(
                                        otherPageApiGetUserResponse.jsonBody,
                                      ),
                                      'nama',
                                    ),
